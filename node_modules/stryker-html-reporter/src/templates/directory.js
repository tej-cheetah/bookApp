...
function directory(scoreResult, breadcrumb, thresholds) {
    return layout_1.layout(breadcrumb, typedHtml.createElement("div", { class: 'col-lg-12' },
        typedHtml.createElement("div", { class: 'row' },
            typedHtml.createElement("div", { class: 'totals col-sm-11' }, resultTable_1.resultTable(scoreResult, breadcrumb.title, thresholds)))));
}
