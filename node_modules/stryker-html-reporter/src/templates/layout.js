...
function layout(breadcrumb, content) {
    ...
    return '<!DOCTYPE html>\n' + typedHtml.createElement("html", null,
        typedHtml.createElement("head", null,
            ...
            typedHtml.createElement("link", { rel: 'stylesheet', href: urlPrefix + "stryker.css" })),
        typedHtml.createElement("body", null,
            typedHtml.createElement("img", { class: 'stryker-image', alt: 'Stryker', src: urlPrefix + "stryker-80x80.png" }),
